...
call copy target\tetrahedron-desktop-1.1.0-SNAPSHOT-jar-with-dependencies.jar tmp\app\Tetrahedron.jar
...
call jpackage --input tmp\app --main-jar Tetrahedron.jar --main-class org.cmps.tetrahedron.Tetrahedron --runtime-image tmp\jre ^
    --name Tetrahedron --vendor "CMPS, KhPI" --app-version 1.1.0 --icon src/main/resources/logo.ico ^
