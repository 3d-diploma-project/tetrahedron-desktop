...
public class WindowsManager {
    ...
    public void init() {
        ...
        GL11.glClearColor(0.0f, 0.0f, 0.0f, 100.0f);
...
//        GL11.glCullFace(GL11.GL_BACK);
    ...
    public boolean windowShouldClose() throws Exception {
        if (window == MemoryUtil.NULL) throw new Exception("Window can't initialized");
