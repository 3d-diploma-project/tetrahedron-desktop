...
import org.cmps.tetrahedron.view.model.component.RightToolbar;
...
public class StressDialog {
    ...
    public static void showDialog(double x, double y) {
        ...
        DialogPane pane = ResourceReader.readComponent("/view/model/StressDialog.fxml", DialogPane.class,
