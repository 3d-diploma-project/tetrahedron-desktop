...
import org.cmps.tetrahedron.view.model.component.ColorEditor;
...
public class ColorPickerDialog {
    ...
    public static void showColorPicker(double x, double y) {
        ...
        DialogPane pane = ResourceReader.readComponent("/view/model/ColorPickerDialog.fxml", DialogPane.class,
